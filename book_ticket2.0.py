...
class Buy_Tickets(object):
    ...
    def check_ticket(self):
        ...
        sleep(0.5)
        while True:
            if type.find_by_value('M'):           # 修改对应座次的 value 值，M 表示一等座，其他对应值详见公众号「Python知识圈」文章
                type.find_by_value('M').click()   # 修改对应座次的 value 值，M 表示一等座，其他对应值详见公众号「Python知识圈」文章
                break                      # ！！！重要提醒，二等座的 value 值是大写的 O，而不是阿拉伯数字0，其他详见文章
...
if __name__ == '__main__':
    ...
    # 日期，格式为：'2019-01-28'
    dtime = '2019-01-31'
    # 出发地(需填写cookie值)，在调试模式下点击查询按钮，查看cookie，详见公众号讲解
    starts = '%u4E0A%u6D77%2CAOH'  # 上海  %u4E0A%u6D77%2CAOH  上海南 %u4E0A%u6D77%u5357%2CSNH
    # 目的地(需填写cookie值)，在调试模式下点击查询按钮，查看cookie，详见公众号讲解
